                ...
                appearance={{
                  elements: {
                    ...
                    organizationSwitcherTrigger:
                      "w-full! justify-start! group-data-[collapsible=icon]:size-8! group-daya-[collapsible=icon]:p-2",
                    organizationPreview:
              ...
              {customerSupportItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton
                    ...
                    className={cn(isActive(item.url) && "bg-gradient-to-b from-sidebar-primary to-[#0b63f6]! text-sidebar-primary-foreground hover:to[#0b63f6]/90!")}
                  >
                    <Link
                      href={item.url}
                    >
